...
| `assembly-guide.html` | https://claude.ai/code/artifact/ed4616c7-05a0-4704-a46b-b46163b0e4fd | The authored source; the artifact is published from this file. Checkbox state lives in the artifact's database, not in the file |
...
The Assembly Guide is checked for structure, for the part numbers and prices it restates from the Build Sheet, and for GPU-build language it must not contain (the build is CPU-only; the 4060 Ti stays in the desktop).
